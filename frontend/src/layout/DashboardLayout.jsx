      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-800">SmartOps</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-50 cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 truncate">admin@smartops.com</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        ...
        <header className="bg-white shadow-sm z-10">
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            ...
            {/* Search and Actions */}
            <div className="flex items-center flex-1 justify-between ml-4 lg:ml-0">
